            ...
            <div className="space-y-6 md:col-span-2">
              <div>
                ...
                <p className="mt-4 text-zinc-400">
                  ...
                  performance and a smooth user experience. The challenge was to build a system that could handle
                  hundreds of element combinations while keeping the interface intuitive and responsive.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2 text-zinc-400">
                  ...
                  <li className="flex items-start">
                    <Sparkles className="mr-2 mt-1 h-4 w-4 flex-shrink-0 text-purple-500" />
                    <span>Custom algorithm for determining new element combinations</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-zinc-400">
                  <li className="flex items-start">
                    ...
                    <span>Casual gamers looking for a relaxing but engaging experience</span>
                  </li>
                  <li className="flex items-start">
                    <Code className="mr-2 mt-1 h-4 w-4 flex-shrink-0 text-purple-500" />
                    <span>Puzzle enthusiasts who enjoy discovery and experimentation</span>
                  </li>
                  <li className="flex items-start">
                    <Share2 className="mr-2 mt-1 h-4 w-4 flex-shrink-0 text-purple-500" />
                    <span>Players who enjoy sharing their discoveries with others</span>
                  </li>
                </ul>
              </div>
