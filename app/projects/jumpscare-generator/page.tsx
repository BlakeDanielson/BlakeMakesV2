...
import { ArrowLeft, ExternalLink, Github, Calendar, Users, Sparkles, Video, Upload, Code, Brain } from "lucide-react"
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-semibold text-white">Auto Timing Assist</h3>
                    </div>
                    <ul className="text-sm text-zinc-400 space-y-1">
                      <li>• Optional beat/onset detection to align scare</li>
                      <li>• Loudness normalization for consistent jumps</li>
                      <li>• Smart defaults for casual users</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
                ...
                <div className="mt-6 flex flex-col gap-3">
                  ...
                  <Link href="https://github.com/BlakeDanielson/jumpscare-generator" target="_blank" rel="noopener noreferrer">
